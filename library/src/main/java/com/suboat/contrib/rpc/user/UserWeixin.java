					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.uids = new java.util.ArrayList<java.lang.String>(_list76.size);
							@org.apache.thrift.annotation.Nullable
			...
			if (struct.uids != null) {
				oprot.writeFieldBegin(UIDS_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING,
							struct.uids.size()));
					for (java.lang.String _iter79 : struct.uids) {
			...
			if (struct.isSetUids()) {
				{
					...
					for (java.lang.String _iter80 : struct.uids) {
			...
			if (incoming.get(0)) {
				{
					...
					struct.uids = new java.util.ArrayList<java.lang.String>(_list81.size);
					@org.apache.thrift.annotation.Nullable
