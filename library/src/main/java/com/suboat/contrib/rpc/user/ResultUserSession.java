					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<UserSession>(_list132.size);
							@org.apache.thrift.annotation.Nullable
							UserSession _elem133;
							for (int _i134 = 0; _i134 < _list132.size; ++_i134) {
								_elem133 = new UserSession();
								_elem133.read(iprot);
			...
			if (struct.data != null) {
				oprot.writeFieldBegin(DATA_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT,
							struct.data.size()));
					for (UserSession _iter135 : struct.data) {
			...
			if (struct.isSetData()) {
				{
					...
					for (UserSession _iter136 : struct.data) {
			...
			if (incoming.get(0)) {
				{
					...
					struct.data = new java.util.ArrayList<UserSession>(_list137.size);
					@org.apache.thrift.annotation.Nullable
					UserSession _elem138;
					for (int _i139 = 0; _i139 < _list137.size; ++_i139) {
						_elem138 = new UserSession();
						_elem138.read(iprot);
