...
public class UserBot implements org.apache.thrift.TBase<UserBot, UserBot._Fields>, java.io.Serializable, Cloneable,
		Comparable<UserBot> {
	...
	private static final org.apache.thrift.protocol.TField PROXY_URL_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"proxyUrl", org.apache.thrift.protocol.TType.STRING, (short) 4);

	private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UserBotStandardSchemeFactory();

	private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UserBotTupleSchemeFactory();
	...
	public @org.apache.thrift.annotation.Nullable java.lang.String proxyUrl; // required
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		...
		UID((short) 1, "uid"), CREATE_TIME((short) 2, "createTime"), UPDATE_TIME((short) 3,
				"updateTime"), PROXY_URL((short) 4, "proxyUrl");
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserBot.class, metaDataMap);
	}

	public UserBot() {
	}

	public UserBot(java.lang.String uid, java.lang.String createTime, java.lang.String updateTime,
	...
	public UserBot deepCopy() {
		return new UserBot(this);
	}
	...
	public UserBot setUid(@org.apache.thrift.annotation.Nullable java.lang.String uid) {
		this.uid = uid;
		return this;
	}
	...
	public UserBot setCreateTime(@org.apache.thrift.annotation.Nullable java.lang.String createTime) {
		this.createTime = createTime;
		return this;
	}
	...
	public UserBot setUpdateTime(@org.apache.thrift.annotation.Nullable java.lang.String updateTime) {
		this.updateTime = updateTime;
		return this;
	}
	...
	public UserBot setProxyUrl(@org.apache.thrift.annotation.Nullable java.lang.String proxyUrl) {
		this.proxyUrl = proxyUrl;
		return this;
	}
	...
	public boolean equals(java.lang.Object that) {
		if (that == null)
			return false;
		if (that instanceof UserBot)
			return this.equals((UserBot) that);
		return false;
	}

	public boolean equals(UserBot that) {
		if (that == null)
			return false;
		if (this == that)
			return true;
	...
	@Override
	public int compareTo(UserBot other) {
	...
	public java.lang.String toString() {
		java.lang.StringBuilder sb = new java.lang.StringBuilder("UserBot(");
		boolean first = true;
	...
	private static class UserBotStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {

		public UserBotStandardScheme getScheme() {
			return new UserBotStandardScheme();
		}

	}

	private static class UserBotStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserBot> {

		public void read(org.apache.thrift.protocol.TProtocol iprot, UserBot struct)
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, UserBot struct)
				throws org.apache.thrift.TException {
			struct.validate();
	...
	private static class UserBotTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {

		public UserBotTupleScheme getScheme() {
			return new UserBotTupleScheme();
		}

	}

	private static class UserBotTupleScheme extends org.apache.thrift.scheme.TupleScheme<UserBot> {

		@Override
		public void write(org.apache.thrift.protocol.TProtocol prot, UserBot struct)
				throws org.apache.thrift.TException {
		...
		@Override
		public void read(org.apache.thrift.protocol.TProtocol prot, UserBot struct)
				throws org.apache.thrift.TException {
