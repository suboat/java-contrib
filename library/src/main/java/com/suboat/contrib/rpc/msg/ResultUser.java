					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<User>(_list8.size);
							@org.apache.thrift.annotation.Nullable
							User _elem9;
			...
			if (incoming.get(0)) {
				{
					...
					struct.data = new java.util.ArrayList<User>(_list13.size);
					@org.apache.thrift.annotation.Nullable
					User _elem14;
