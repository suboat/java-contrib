...
public class ResultLabel implements org.apache.thrift.TBase<ResultLabel, ResultLabel._Fields>, java.io.Serializable,
					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<Label>(_list100.size);
							@org.apache.thrift.annotation.Nullable
							Label _elem101;
							for (int _i102 = 0; _i102 < _list100.size; ++_i102) {
								_elem101 = new Label();
								_elem101.read(iprot);
								struct.data.add(_elem101);
							}
							iprot.readListEnd();
						}
			...
			if (struct.data != null) {
				oprot.writeFieldBegin(DATA_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT,
							struct.data.size()));
					for (Label _iter103 : struct.data) {
	...
	private static class ResultLabelTupleScheme extends org.apache.thrift.scheme.TupleScheme<ResultLabel> {
			...
			if (struct.isSetData()) {
				{
					...
					for (Label _iter104 : struct.data) {
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, ResultLabel struct)
			...
			if (incoming.get(0)) {
				{
					org.apache.thrift.protocol.TList _list105 = new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
					struct.data = new java.util.ArrayList<Label>(_list105.size);
					@org.apache.thrift.annotation.Nullable
					Label _elem106;
