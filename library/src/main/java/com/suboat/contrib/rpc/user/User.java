...
public class User
	...
	private static final org.apache.thrift.protocol.TField STATUS_ID_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"statusId", org.apache.thrift.protocol.TType.I32, (short) 20);
										...
										"unique"), SALT((short) 14, "salt"), SOURCE((short) 15, "source"), STATUS_EMAIL(
												...
												"statusEmail"), STATUS_PHONE((short) 17, "statusPhone"), STATUS_PSW(
														(short) 18, "statusPsw"), STATUS_QUEST((short) 19,
																"statusQuest"), STATUS_ID((short) 20,
																		"statusId"), IS_TWO_FACTOR((short) 21,
	...
	private static final int __STATUSID_ISSET_ID = 9;
	...
	static {
		...
		tmpMap.put(_Fields.STATUS_QUEST,
				new org.apache.thrift.meta_data.FieldMetaData("statusQuest",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
		tmpMap.put(_Fields.STATUS_ID,
				new org.apache.thrift.meta_data.FieldMetaData("statusId",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
	...
	public User(java.lang.String uid, boolean isStaff, boolean isActive, boolean isDelete, java.lang.String createTime,
			...
			java.lang.String source, int statusEmail, int statusPhone, int statusPsw, int statusQuest, int statusId,
	...
	public User setStatusId(int statusId) {
		this.statusId = statusId;
		setStatusIdIsSet(true);
		return this;
	}
	...
	/**
	 * Returns true if field statusId is set (has been assigned a value) and false
	 * otherwise
	 */
