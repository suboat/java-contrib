					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<User>(_list116.size);
							@org.apache.thrift.annotation.Nullable
							User _elem117;
			...
			if (incoming.get(0)) {
				{
					...
					struct.data = new java.util.ArrayList<User>(_list121.size);
					@org.apache.thrift.annotation.Nullable
					User _elem122;
