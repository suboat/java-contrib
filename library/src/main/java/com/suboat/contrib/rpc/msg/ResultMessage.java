 ...
 * 接口返回: 数据列表 应用场景: 数据列表
 */
public class ResultMessage implements org.apache.thrift.TBase<ResultMessage, ResultMessage._Fields>,
		java.io.Serializable, Cloneable, Comparable<ResultMessage> {
	...
	private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ResultMessageStandardSchemeFactory();

	private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ResultMessageTupleSchemeFactory();

	public @org.apache.thrift.annotation.Nullable java.util.List<Message> data; // required
	...
	public ResultMessage(java.util.List<Message> data, com.suboat.contrib.rpc.base.QueryMeta meta) {
		this();
		this.data = data;
		this.meta = meta;
	}
	...
	public ResultMessage(ResultMessage other) {
		if (other.isSetData()) {
			java.util.List<Message> __this__data = new java.util.ArrayList<Message>(other.data.size());
	...
	public void addToData(Message elem) {
		if (this.data == null) {
			this.data = new java.util.ArrayList<Message>();
		}
		this.data.add(elem);
	}
	...
	public ResultMessage setData(@org.apache.thrift.annotation.Nullable java.util.List<Message> data) {
		this.data = data;
		return this;
	}
	...
	public ResultMessage setMeta(@org.apache.thrift.annotation.Nullable com.suboat.contrib.rpc.base.QueryMeta meta) {
		this.meta = meta;
		return this;
	}
	...
	public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
		...
		case DATA:
			if (value == null) {
				...
				setData((java.util.List<Message>) value);
			}
			break;
	...
	public java.lang.String toString() {
		java.lang.StringBuilder sb = new java.lang.StringBuilder("ResultMessage(");
		boolean first = true;
	...
	private static class ResultMessageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
	...
	private static class ResultMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<ResultMessage> {

		public void read(org.apache.thrift.protocol.TProtocol iprot, ResultMessage struct)
					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<Message>(_list0.size);
							@org.apache.thrift.annotation.Nullable
							Message _elem1;
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, ResultMessage struct)
				throws org.apache.thrift.TException {
			struct.validate();
			...
			if (struct.data != null) {
				oprot.writeFieldBegin(DATA_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT,
							struct.data.size()));
					for (Message _iter3 : struct.data) {
						_iter3.write(oprot);
					}
					oprot.writeListEnd();
				}
	...
	private static class ResultMessageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
	...
	private static class ResultMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<ResultMessage> {

		@Override
		public void write(org.apache.thrift.protocol.TProtocol prot, ResultMessage struct)
				throws org.apache.thrift.TException {
			...
			if (struct.isSetData()) {
				{
					...
					for (Message _iter4 : struct.data) {
						_iter4.write(oprot);
					}
				}
			}
		...
		@Override
		public void read(org.apache.thrift.protocol.TProtocol prot, ResultMessage struct)
				throws org.apache.thrift.TException {
			...
			if (incoming.get(0)) {
				{
					...
					struct.data = new java.util.ArrayList<Message>(_list5.size);
					@org.apache.thrift.annotation.Nullable
					Message _elem6;
