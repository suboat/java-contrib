					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.privilege = new java.util.ArrayList<java.lang.String>(_list102.size);
							@org.apache.thrift.annotation.Nullable
							java.lang.String _elem103;
							for (int _i104 = 0; _i104 < _list102.size; ++_i104) {
								_elem103 = iprot.readString();
								struct.privilege.add(_elem103);
							}
							iprot.readListEnd();
						}
			...
			if (struct.privilege != null) {
				if (struct.isSetPrivilege()) {
					oprot.writeFieldBegin(PRIVILEGE_FIELD_DESC);
					{
						...
						for (java.lang.String _iter105 : struct.privilege) {
			...
			if (struct.isSetPrivilege()) {
				{
					...
					for (java.lang.String _iter106 : struct.privilege) {
			...
			if (incoming.get(8)) {
				{
					...
					struct.privilege = new java.util.ArrayList<java.lang.String>(_list107.size);
					@org.apache.thrift.annotation.Nullable
					java.lang.String _elem108;
					for (int _i109 = 0; _i109 < _list107.size; ++_i109) {
						_elem108 = iprot.readString();
						struct.privilege.add(_elem108);
					}
				}
				struct.setPrivilegeIsSet(true);
			}
