...
public class UserWeixinBase implements org.apache.thrift.TBase<UserWeixinBase, UserWeixinBase._Fields>,
					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.privilege = new java.util.ArrayList<java.lang.String>(_list84.size);
							@org.apache.thrift.annotation.Nullable
							java.lang.String _elem85;
							for (int _i86 = 0; _i86 < _list84.size; ++_i86) {
								_elem85 = iprot.readString();
								struct.privilege.add(_elem85);
							}
							iprot.readListEnd();
						}
			...
			if (struct.privilege != null) {
				if (struct.isSetPrivilege()) {
					oprot.writeFieldBegin(PRIVILEGE_FIELD_DESC);
					{
						...
						for (java.lang.String _iter87 : struct.privilege) {
	...
	private static class UserWeixinBaseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UserWeixinBase> {
			...
			if (struct.isSetPrivilege()) {
				{
					...
					for (java.lang.String _iter88 : struct.privilege) {
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, UserWeixinBase struct)
			...
			if (incoming.get(8)) {
				{
					org.apache.thrift.protocol.TList _list89 = new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.STRING, iprot.readI32());
					struct.privilege = new java.util.ArrayList<java.lang.String>(_list89.size);
					@org.apache.thrift.annotation.Nullable
					java.lang.String _elem90;
					for (int _i91 = 0; _i91 < _list89.size; ++_i91) {
						_elem90 = iprot.readString();
						struct.privilege.add(_elem90);
					}
				}
				struct.setPrivilegeIsSet(true);
			}
