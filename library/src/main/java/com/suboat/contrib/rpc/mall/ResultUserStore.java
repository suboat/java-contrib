...
public class ResultUserStore implements org.apache.thrift.TBase<ResultUserStore, ResultUserStore._Fields>,
					...
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							...
							struct.data = new java.util.ArrayList<UserStore>(_list76.size);
							@org.apache.thrift.annotation.Nullable
							UserStore _elem77;
							for (int _i78 = 0; _i78 < _list76.size; ++_i78) {
								_elem77 = new UserStore();
								_elem77.read(iprot);
			...
			if (struct.data != null) {
				oprot.writeFieldBegin(DATA_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT,
							struct.data.size()));
					for (UserStore _iter79 : struct.data) {
						_iter79.write(oprot);
					}
					oprot.writeListEnd();
				}
	...
	private static class ResultUserStoreTupleScheme extends org.apache.thrift.scheme.TupleScheme<ResultUserStore> {
			...
			if (struct.isSetData()) {
				{
					...
					for (UserStore _iter80 : struct.data) {
						_iter80.write(oprot);
					}
				}
			}
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, ResultUserStore struct)
			...
			if (incoming.get(0)) {
				{
					org.apache.thrift.protocol.TList _list81 = new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
					struct.data = new java.util.ArrayList<UserStore>(_list81.size);
					@org.apache.thrift.annotation.Nullable
					UserStore _elem82;
					for (int _i83 = 0; _i83 < _list81.size; ++_i83) {
						_elem82 = new UserStore();
						_elem82.read(iprot);
